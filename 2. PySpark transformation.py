...
# MAGIC %md
# MAGIC # PySparkによるデータ変換
# MAGIC
# MAGIC PythonからApache Sparkを操作する際に使用するAPIであるPySparkの基本的な使い方を説明します。
# MAGIC
# MAGIC **参考資料**
# MAGIC - [PySparkことはじめ \#Databricks \- Qiita](https://qiita.com/taka_yayoi/items/a7ee6287031374efa88a)
...
# MAGIC
# MAGIC [Pandas API on Spark \| Databricks Documentation](https://docs.databricks.com/aws/ja/pandas/pandas-on-spark)
